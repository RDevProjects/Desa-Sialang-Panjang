...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('assets/users/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/users/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/users/vendor/aos/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/users/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/users/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
...
<body class="index-page">
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
                        <img src="{{ asset('assets/users/img/hero-img.png') }}" class="img-fluid animated"
                            alt="">
                    </div>
                </div>
            </div>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('assets/users/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('assets/users/vendor/php-email-form/validate.js') }}"></script>
    <script src="{{ asset('assets/users/vendor/aos/aos.js') }}"></script>
    ...
    <script src="{{ asset('assets/users/vendor/waypoints/noframework.waypoints.js') }}"></script>
    <script src="{{ asset('assets/users/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
