...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/vendor/fontawesome-free/css/all.min.css') }}">
    <link
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Sistem
                                            Informasi <br>{{ env('APP_NAME') }}
                                        </h1>
                                    </div>
